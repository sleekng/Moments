<!-- RightSideImage.vue -->
<template>
    <div class="hidden lg:flex w-4/6 h-auto lg:p-8 relative justify-center p-4 items-end bg-gradient-to-r from-pink-300 to-blue-300 rounded-2xl" style="background-position: center -100px; background-size: cover;">
