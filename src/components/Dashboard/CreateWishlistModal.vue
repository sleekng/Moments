  ...
  <transition name="fade">
    <div v-if="isVisible" class="fixed z-50 inset-0 overflow-y-auto py-4 px-4">
      <div class="flex items-center justify-center">
        ...
        <div class="bg-white rounded-lg shadow-xl transform transition-all overflow-hidden lg:max-w-[750px]">
            ...
            <div class="col-span-2 space-y-4">
              <div class="w-full space-y-4">
                ...
                <div class="relative">
                  ...
                  <input v-model="form.date" class="w-full p-3 bg-white border border-gray-300 rounded-md" type="date" id="event-date"/>
                </div>

                <div>
                  <label class="block text-gray-700 mb-2" for="description">Description (Optional)</label>
                  <textarea v-model="form.description" class="w-full p-3 bg-white border border-gray-300 rounded-md" id="description" placeholder="Describe the event" rows="3"></textarea>
                </div>
                ...
                <div>
                  ...
                  <div class="space-y-4">
                    <div class="flex items-center gap-4" @click="selectedOption = 'public'">
                      ...
                      <img :src="selectedOption === 'public' ? '/assets/web-radio-btn.svg' : '/assets/web-radio-btn-2.svg'" class="ml-auto w-5 h-5 cursor-pointer" alt="Radio button"/>
                    </div>
          ...
          <div class="p-6 flex lg:flex-row flex-col lg:justify-end lg:space-x-4">
            ...
            <button @click="saveWishlist" class="py-2 mt-4 lg:mt-0 px-6 bg-primaryColor text-white rounded-full">{{ buttonText }}</button>
          </div>
        </div>
      </div>
    </div>
