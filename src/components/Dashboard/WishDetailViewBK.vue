    ...
    <div class="bg-white rounded-2xl max-w-4xl w-full   h-[98vh] lg:h-auto  shadow-lg p-6 mx-auto relative">
        ...
        <div class="flex flex-col lg:flex-row gap-8 relative overflow-y-auto h-full lg:h-auto lg:pb-0 pb-4">
            ...
            <div class="relative rounded-lg overflow-hidden ">
                <img src="/assets/image-59.svg" alt="Hermes Birkin Bag" class="w-[364px] lg:h-auto object-cover">
                <img src="/assets/gradient.svg" alt="Gradient Overlay" class="absolute bottom-0 w-full  object-cover">

                <div class="absolute bottom-4 left-4 text-white">
                    <div class=" w-auto">
                        <div class="inline-flex items-center bg-red-100 border border-red-600 text-red-600 text-sm font-medium py-1 px-2 rounded-full">
                            High priority
                            <img src="/assets/frame-1618868307.svg" alt="Fire" class="ml-2 w-4 h-4" />
                        </div>
                    </div>

                    <div class="mb-1 mt-8 text-2xl font-bold">{{ wish.title }}</div>
                    <div class="flex items-center space-x-2">
                        <span class="text-xl font-semibold">{{ wish.price }}</span>
                        <img src="/assets/ellipse-18.svg" alt="Separator" class="w-1 h-1">
                        <span class="text-base">Qty: 20</span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex-1 lg:space-y-6 space-y-2">
                <div class="flex justify-between items-center relative">
                    <div class="space-y-1">
                        <div class="flex items-center space-x-2 text-sm text-gray-600">
                            ...
                            <span>Event date: </span> {{ wish.id }}
                            <span class="font-medium text-gray-800">23 May, 2024</span>
                        </div>
                    </div>
                    <div class="relative ">
                ...
                <div class="lg:space-y-6 space-y-4">
                    ...
                    <div class="bg-gray-100 p-4 rounded-lg">
                        ...
                        <p class="text-gray-800 mt-1">I want the brown one in medium size. Kindly get it from the website. Thank you.</p>
                    </div>
                    <div class="text-sm flex items-center space-x-2">
                        <span class="text-gray-600">Buy it here: </span>
                        <a href="http://www.website.com" class="text-blue-600">www.website.com</a>
                    </div>

                    <!-- Received Indicator -->
                    <div v-if="wish.status == 'received'" class="inline-flex items-center space-x-2 rounded-full px-4 py-2 bg-[#F4F9F6]">
                    ...
                    <!-- Reserved Indicator -->
                    <div v-if="wish.status == 'reserved'" class="inline-flex items-center space-x-2 rounded-full px-4 py-2   bg-[#FEF8EF]">
                    ...
                    <!-- FulFilled Indicator -->
                    <div v-if="wish.status == 'fulfilled'" class="inline-flex items-center space-x-2 rounded-full px-4 py-2 bg-[#F4F9F6]">
                    ...
                    <div class="flex items-center space-x-2 text-gray-600">
                        <img src="/assets/heart.svg" alt="Likes" class="w-5 h-5" />
                ...
                <div v-if="wish.status == 'saved'" class=" absolute bottom-0 right-0 ">
                    <div v-if="isDashboard" class="pt-8 h-full items-end flex justify-between w-full space-x-4 relative">
                        <div class="flex-1"></div>
                        <button class="flex-1  py-3 bg-primaryColor px-16 whitespace-nowrap text-white rounded-full hover:shadow-lg">
                            Reserve Wish
                        </button>
                    </div>
                </div>
                ...
                <div v-if="wish.status == 'reserved'">
                    <div v-if="isDashboard" class="pt-8 flex justify-between w-full space-x-4 relative">
                        <div class="flex-1"></div>
                        <button class="flex-1 px-8 py-3 bg-primaryColor text-white rounded-full hover:shadow-lg">
                            Request address
                        </button>
                    </div>
                    <div v-else class="pt-8 flex justify-between w-full space-x-4 relative">
