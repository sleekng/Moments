<template>
  <div class="card group hover:border-primaryColor  cursor-pointer border-gray-100" :class="['bg-white rounded-lg shadow-md p-4 my-4  border', isDropdownOpen ? 'border-primaryColor' : 'border-transparent']">
