  ...
  export default {
    ...
    data() {
      return {
        ...
        people: [
          { name: "Ayomide Shotayo", username: "@ayomide_sm", wishlists: 10 },
          { name: "John Doe", username: "@john_doe", wishlists: 5 },
        ],
        wishlists: [
          { name: "My Birthday Wishlist", username: "@ayomide_sm", wishes: 10 },
          { name: "Christmas Gifts", username: "@john_doe", wishes: 7 },
        ],
        filteredPeople: [],
        filteredWishlists: [],
      };
    ...
    methods: {
      ...
      filterResults() {
        ...
        this.filteredPeople = this.people.filter((person) => person.name.toLowerCase().includes(query));
        this.filteredWishlists = this.wishlists.filter((wishlist) => wishlist.name.toLowerCase().includes(query));
      },
      clearSearch() {
        this.searchQuery = '';
        this.filteredPeople = [];
