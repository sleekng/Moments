    ...
    <div class="flex flex-col md:flex-row lg:items-center md:items-start mb-4 lg:mb-8">
      <div class="flex lg:block justify-between w-full lg:w-auto items-center">
        ...
        <div class="flex justify-center md:justify-start lg:mt-4 md:mt-0 space-x-4 lg:hidden hover:shadow-xl hover:text-primaryColor transition-all">
          <button v-if="isDashboard" @click="showAnalyticsModal" class="bg-gray-100 text-[#2D3036] py-2 px-4 md:px-6 rounded-full">
            View analytics
          </button>
      ...
      <div class="flex items-start self-start">
        ...
        <div class="justify-center md:justify-start mt-4 md:mt-0 space-x-4 hidden lg:flex relative">
          <button v-if="isDashboard"  @click="showAnalyticsModal" class="bg-gray-100 text-[#2D3036] py-2 px-4 md:px-6 rounded-full hover:shadow-lg hover:text-primaryColor transition-all">
            View analytics
          </button>
          <button @click="toggleShareMenu" class="bg-gray-100 text-[#2D3036] py-2 px-6 rounded-full hover:shadow-lg hover:text-primaryColor transition-all">
            Share profile
          </button>
