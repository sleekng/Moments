...
<div class="bg-white lg:bg-gray-100 py-10">
    ...
    <div class="px-4 lg:px-16  pt-10  lg:pt-20">
        <ProfileCover />
...
export default {
    ...
    data() {
        return {
            ...
            showInitialModal: false, // Control initial modal visibility
    ...
    mounted() {
    // Check if the 'showCongratulations' query param is set to true
